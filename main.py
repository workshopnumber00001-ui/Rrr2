...
# Negated auth filter (without using ~)
...
async def txt_handler(bot: Client, m: Message):
        ...
        for i in range(arg-1, len(links)):
            ...
            try:
                if "drive" in url:
                    ...
                    await bot.send_document(chat_id=channel_id, document=ka, caption=cc, parse_mode=ParseMode.HTML)
                    count += 1
                    os.remove(ka)
                    continue
                        ...
                        for attempt in range(max_retries):
                            try:
                                ...
                                if response.status_code == 200:
                                    ...
                                    await bot.send_document(chat_id=channel_id, document=f'{name}.pdf', caption=cc, parse_mode=ParseMode.HTML)
                                    count += 1
                    ...
                    await bot.send_document(chat_id=channel_id, document=f"{name}.html", caption=cc, parse_mode=ParseMode.HTML)
                    ...
                    await bot.send_photo(chat_id=channel_id, photo=f'{name}.{ext_actual}', caption=cc, parse_mode=ParseMode.HTML)
                    count += 1
                    ...
                    await bot.send_document(chat_id=channel_id, document=f'{name}.{ext_actual}', caption=cc, parse_mode=ParseMode.HTML)
                    os.remove(f'{name}.{ext_actual}')
                    count += 1
                    continue
                    ...
                    try:
                        ...
                        if os.path.exists(filename):
                            ...
                            await bot.send_message(channel_id, f'⚠️ Failed to decrypt.', parse_mode=ParseMode.HTML)
                            failed_count += 1
                            count += 1
                            continue
                    except Exception as e:
                ...
                await bot.send_message(channel_id, f'⚠️ Download Failed: {str(e)}', parse_mode=ParseMode.HTML)
                failed_count += 1
                count += 1
                continue

    except Exception as e:
        await m.reply_text(str(e), parse_mode=ParseMode.HTML)
        time.sleep(2)
    ...
    if raw_text7 == "/d":
        ...
        await bot.send_message(channel_id, f"✅ Completed: {b_name}\nTotal: {len(links)}, Success: {success_count}, Failed: {failed_count}", parse_mode=ParseMode.HTML)
        await bot.send_message(m.chat.id, f"✅ Task completed. Check your channel.", parse_mode=ParseMode.HTML)
